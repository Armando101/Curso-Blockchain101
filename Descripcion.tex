...
El alumno tendrá conocimiento sobre términos técnicos blockchain, sus orígenes y los problemas que resuelve.
...
Puede variar dependiendo el horario del curso
\textbf{Lunes}:
\begin{itemize}
...
\end{itemize}
\item \textbf{Ledger}: es el libro contable donde se encuentras todas las transacciones que se han hecho desde el día cero, estas transacciones se encuentran en bloques.
\end{itemize}
...
El dinero fiat no existe en papel sino en bases de datos, a esta se le conoce como hoja de cuentas, libro mayor o ledger.\\
...
Qué pasará con el número de transacciones cuando comience a crecer. Todo el ledger va quedando guardado y cada vez hay más transaccione, aquí habla de ideas para cuidar el espacio de almacenamiento, una de ellas es guardar los headers para acceder a las transacciones. Consideraron la ley de moore que indica que en el futuro se tendrá mayor capacidad de cómputo del que había en la época.
\item \textbf{La Verificación} (Simplified Payment Verification):
Para verificar que un pago sucedió no necesitas tener el ledger completo de transacciones de tu moneda para verificar que la transacción existe, puedes buscar simplemente con los headers,  esta información es muy transparente y existen muchos repositorios públicos donde puedes ir a consultar transacciones por el hash o navegando.
...
Al final del curso se propone una actividad en la cual los alumnos forman equipos y proponen una idea que consiste en pensar donde aplicarían la tecnología blockchain así como cuál sería el protocolo de consenso y con qué fin lo harían, esto con el objetivo de que el alumno ponga en práctica lo aprendido en el curso.
